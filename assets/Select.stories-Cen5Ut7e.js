import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{z as l}from"./Alert-5RVefPd9.js";import"./index-yBjzXJbu.js";import"./index-BlmOqGMO.js";const z={title:"Components/Select",component:l,parameters:{layout:"padded"},argTypes:{size:{control:{type:"select"},options:["xs","sm","md","lg","xl"]}},tags:["autodocs"]},s={args:{options:[{label:"All Classes",value:"all"},{label:"Class 10-A",value:"10a"},{label:"Class 9-B",value:"9b"},{label:"Class 8-C",value:"8c"}]}},a={render:()=>e.jsxs("div",{className:"space-y-3",children:[e.jsx(l,{size:"xs",options:[{label:"XS",value:"xs"}]}),e.jsx(l,{size:"sm",options:[{label:"SM",value:"sm"}]}),e.jsx(l,{size:"md",options:[{label:"MD",value:"md"}]}),e.jsx(l,{size:"lg",options:[{label:"LG",value:"lg"}]}),e.jsx(l,{size:"xl",options:[{label:"XL",value:"xl"}]})]})},n={render:()=>e.jsxs(l,{children:[e.jsx("option",{value:"",children:"Select status"}),e.jsx("option",{value:"active",children:"Active"}),e.jsx("option",{value:"inactive",children:"Inactive"}),e.jsx("option",{value:"leave",children:"On Leave"})]})};var o,t,i;s.parameters={...s.parameters,docs:{...(o=s.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {
    options: [{
      label: "All Classes",
      value: "all"
